		...
		do{
            ...
            case 2:{
				...
				if(lib.equals(y)){
					...
					case 3:{try{ArrayList<BooksTransaction>list = 
							service.getAlltrans();
							for(BooksTransaction obj : list)
							{
					...
					break;
					case 3:{int id=service.get_Reg_Id(userid);
						BooksTransaction book= service.showDetail(id);
						System.out.println("Book Details Of "+id+" i :");
