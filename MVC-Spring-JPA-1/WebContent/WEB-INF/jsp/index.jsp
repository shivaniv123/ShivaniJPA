	...
	<div>
		...
		<form:form modelAttribute="student" action="save.obj" method="post">
			<div>
				...
				<div>
					<form:input path="firstName" id="fname"  placeholder="First Name"/><!--path indicate the variable in entites file  -->
			...
			<div>
				...
				<div>
					<form:input path="phnNo" id="phnNo"  />
					<form:errors path="phnNo" style="color:red"/>
		...
		<c:if test="${stuList ne null}">
			<table>
				...
				<c:forEach items="${stuList}" var="student">
					...
					<tr>
					  <th><a href="index.obj?id=${student.studentId}">${student.studentId}</a>  </th>
